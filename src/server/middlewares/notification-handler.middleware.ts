...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': {
    roles: ['owner', 'admin', 'customer-support-representative'],
    key: 'order_id',
    tenantPath: [],
    userPath: [],
  },
  'ticket_raised.create': {
    roles: ['owner', 'admin', 'customer-support-representative'],
    key: 'ticket_id',
    tenantPath: [],
    userPath: [],
  },
  'payment_received.create': { roles: ['owner', 'admin'], key: 'payment_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'admin', 'customer-support-representative'];
