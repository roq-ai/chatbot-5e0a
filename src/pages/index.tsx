  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Chatbot: Your omnichannel solution for seamless customer interactions. Configure, chat, and connect across multiple platforms with our AI-powered, GPT trained assistant."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1675865254433-6ba341f0f00b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0Ym90fGVufDB8fHx8MTY5NTg4NDIyMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@siva_photography?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Levart_Photographer`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Chatbot: Your omnichannel solution for seamless customer interactions. Configure, chat, and connect across multiple platforms with our AI-powered, GPT trained assistant.`}
            </Text>
            <Box
